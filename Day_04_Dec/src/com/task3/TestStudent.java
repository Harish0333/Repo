...
public class TestStudent 
{
	public static void main(String[] args) 
	{
	        ...
	        double remainingAmountDayScholar = dayScholar.payFee(13000.0);
	        ...
	        double remainingAmountHosteller = hosteller.payFee(25000.0);
	        System.out.println("Remaining amount to pay is: " + remainingAmountHosteller);
	 }
}
