...
public class CabCustomerServiceTester 
{
	public static void main(String[] args) 
	{
		...
		CabCustomer c1=new CabCustomer(12,"Harish","Ameerpet","Prakash Nagar",5,"9059339944");
		CabCustomer c2=new CabCustomer(21,"Charan","Lumbini park","Hytech city",10,"9848745177");
		
		cabservice.addCabCustomer(c2);
		cabservice.addCabCustomer(c1);
		
		System.out.println(cabservice.printBill(c2));
		System.out.println(cabservice.printBill(c1));
	}
